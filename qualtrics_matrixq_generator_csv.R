qualtrics_matrixq_generator_table <- function(table, varcol, itemcol, itemformat = "_number",
                                        responses = FALSE,
...
qualtrics_matrixq_responsescales_table <- function(table, varcol, leadin, resp, resplabel, itemformat = "_number")
  require(tidyverse)
  x <- table
  pattern <- "(?=(?:.*_.*))_"
